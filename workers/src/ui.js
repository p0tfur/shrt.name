...
<body>
  ...
  <div class="container">
    ...
    <footer class="footer">
      <p>SHRT.NAME // 2026</p>
      <p style="margin-top: 10px; font-size: 0.65rem; color: var(--text-muted); letter-spacing: 0.05em; text-transform: none;">
        Do you use social media? Try <a href="https://crosspostingpal.com?ref=shrt.name" target="_blank">crosspostingpal.com</a>
      </p>
    </footer>
  </div>
